...
- **[jupyterlab-lsp](https://github.com/jupyter-lsp/jupyterlab-lsp)** - Language Server Protocol integration
- **[jupyterlab-git](https://github.com/jupyterlab/jupyterlab-git)** - Git extension for JupyterLab
- **[nbconvert](https://github.com/jupyter/nbconvert)** - Notebook conversion to HTML, PDF, and other formats

### Language Server and Code Tools

- **[python-lsp-server](https://github.com/python-lsp/python-lsp-server)** - Python language server with all plugins
